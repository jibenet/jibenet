    ...
    <script type="text/javascript">
        $(function () {
            $("#btnEclick").click(function () {
                ...
                if ($('#eSearch').val() == '') {
                    url = $('#jumpMenu :selected').val().replace(' ', '_') + '/Brasil/SP/São_Paulo/Escritório_Comercial';
                }
                else {
        ...
        $(function () {
            $("#btnLclick").click(function () {
                ...
                if ($('#lSearch').val() == '') {
                    url = $('#Select1 :selected').val().replace(' ', '_') + '/Brasil/SP/São_Paulo/Loja_Comercial';
                }
                else {
                                ...
                                <div style="width: 96%; float: left; border: 1px solid #ccc; border-radius: 10px; padding: 2%; margin-top: 10px;">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ID="rvalEmail" runat="server" ErrorMessage="" ControlToValidate="txtEmail" ValidationGroup="property" CssClass="auto-style1">*</asp:RequiredFieldValidator>

                                            <asp:RegularExpressionValidator ID="revalEmail" runat="server" ErrorMessage="" ControlToValidate="txtEmail" ValidationGroup="property" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" CssClass="auto-style1"></asp:RegularExpressionValidator>
                                            <br>
                                            <br>
                                            <label>Nome</label>
