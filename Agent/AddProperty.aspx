                ...
                <div style="background-color: #fff; width: 96%; float: left; border-radius: 10px; box-shadow: 2px 2px 4px #E9E9E9; padding: 2%;">
                    ...
                    <form id="form" runat="server">
                        ...
                        <div style="width: 96%; float: left; border: 1px solid #ccc; border-radius: 10px; padding: 2%;">
                            ...
                            <div id="canvas" style="float: left; width: 38%; margin: 0px 0px 0px 10px; border: 1px solid #ccc; min-height: 350px; margin-left: -71px; -moz-box-shadow: 1px 1px 3px #888; -webkit-box-shadow: 1px 1px 3px #888; box-shadow: 1px 1px 3px #888;">
                            </div>
