...
public class ValidationMessages
{
    ...
    public static readonly string Date =
       "Por favor insira um de data válido yyyy-mm-dd.";
    ...
    public static readonly string ZipCode = "Válido é # # # # # ou # # # # # - # # # formato.";
    public static readonly string Phone = "Válido é # # # # # - # # # # formato.";
